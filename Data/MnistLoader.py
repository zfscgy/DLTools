...
class MnistLoader:
    def __init__(self):
        ...
        train_images, train_labels = self._get_data_and_labels(train_paths[0], train_paths[1])
        test_images, test_labels = self._get_data_and_labels(test_paths[0], test_paths[1])
    ...
    @staticmethod
    def _get_data_and_labels(images_filename, labels_filename):
        # print("Opening files ...")
